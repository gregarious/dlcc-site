                ...
                <aside id="main-aside">
                    ...
                    <div class="flickr-container">
                        ...
                        <div class="flickr-badge">
                            <style type="text/css">
                                .zg_div {margin:10px 5px 5px 25px; width:117px;}
                                .zg_div_inner {background-color:#ffffff;  color:#666666; text-align:center; font-family:arial, helvetica; font-size:11px;}
                                .zg_div a, .zg_div a:hover, .zg_div a:visited {color:#666; background:inherit !important; text-decoration:none !important;}
                            </style>
                            <script type="text/javascript">
                                zg_insert_badge = function() {
                                    ...
                                    if (document.getElementById) document.write('<div id="zg_whatlink"><a href="http://www.flickr.com/badge.gne"    style="color:#666;" onclick="zg_toggleWhat(); return false;"><\/a><\/div>');
                                }

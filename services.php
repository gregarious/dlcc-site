...
if (function_exists('getSiteTitle')) {
    $siteTitle = getSiteTitle('Our Services');
}
...
<ul>
    ...
    <li>world class entertainment and marketing concepts</li>
    <li>world class service from industry leaders in event technology</li>
</ul>
<p>For more information please phone 412.325.6115 or send email to <a href="mailto:jwalsh@3riversentertainment.com">jwalsh@3riversentertainment.com.</a></p>
